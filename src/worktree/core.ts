/**
 * Virtual Worktree 公开类型、接口与错误
 *
 * 本文件是 `nano-git/worktree/core` 子路径的唯一入口，
 * 包含 VirtualWorktree 的公开 API 边界定义。
 *
 * 约定：
...
export interface VirtualWorktree {
   ...
   * 复制路径
   *
   * 新建 worktree node，共享 origin，不共享 node 身份。
