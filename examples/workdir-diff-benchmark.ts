 ...
 *
 * 用法：
 * - `bun run examples/workdir-diff-benchmark.ts`
 * - `bun run examples/workdir-diff-benchmark.ts --quick`
 */
...
console.log("=== Virtual Workdir diff benchmark ===");
...
function computeBaselineDiff(repo: Repository, state: VirtualWorkdirStateStore) {
