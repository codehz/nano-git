/**
 * workdir/directory-view.ts 目录视图辅助逻辑测试
 *
 * 从原 workdir-path.test.ts 拆分而来，仅保留 directory-view.ts 相关测试。
 */
...
import { getDirectoryChildrenView } from "@/workdir/workdir-path.ts";
